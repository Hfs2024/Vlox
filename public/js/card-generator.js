...
function updatePreview(itemToUpdate) {
  ...
  if (itemToUpdate === "bio") NS("#card-generator-bio").setText(NS("#card-generator-bio-input").getVal()[0] || capitalizeFirstLetter(window.currentUserQuickInfo.bio));
...
<div id='card-generator-image-preview'>
  <p class='card-generator-preview-item' id='card-generator-username' data-type='username'></p>
  <p class='card-generator-preview-item' data-type='age'>Age: <span id='card-generator-age'>N/A</span></p>
  <p class='card-generator-preview-item' id='card-generator-bio' data-type='bio'>${capitalizeFirstLetter(window.currentUserQuickInfo.bio)}</p>
...
<hr>
<div class='taskbar'>
  <button class='taskbar-button on-bg-color'>Basic</button>
...
<div class='taskbar-panel'>
  ...
  // Username
  NS("#card-generator-username").setText(`${window.currentUserQuickInfo.emoji} ${capitalizeFirstLetter(window.currentUserQuickInfo.username) || "User"}`);
