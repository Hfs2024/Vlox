...
router.post("/api/v1/get/user-pinned-posts", checkAuth, async (req, res) => {
    try {
...
router.put("/api/v1/update/user-bio", checkAuth, async (req, res) => {
    try {
...
router.put("/api/v1/update/emoji", checkAuth, async (req, res) => {
    try {
